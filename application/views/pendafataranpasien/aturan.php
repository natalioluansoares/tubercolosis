<div class="wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
                                    ...
                                    foreach ($user_gejala as $rs) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="" class="tabledit-delete-button btn btn-sm btn-warning btn-animation mb-2" data-toggle="modal" data-animation="wobble" data-target=".addaturan" title="Input Data Solusi"><i class="ti-save"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
            ...
            <div class="modal fade addaturan" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="<?= base_url('dokterperawatbidan/aturan'); ?>" method="POST">
                            <div class="modal-body">
                                <label for="namagejala">Nama Gejala</label>
                                <div class="input-group">
                                    <select name="gea" id="" class="form-control">
                                        <option value="">Pilih Penyakit</option>
                                        <?php foreach ($geja as $rs) : ?>
                                            <option value="<?= $rs['nama_gejala'] ?>"><?= $rs['nama_gejala'] ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
