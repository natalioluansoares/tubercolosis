                                ...
                                foreach ($details as $Dt) : ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?= $Dt['isi_solusi']; ?></td>
                                            <td><?= date('d,F,Y', $Dt['tanggal_diagnosa']); ?></td>
                                            <td><a href="" title="Click Untuk Download File Pendaftaran Pasien" class="btn btn-default btn-xs text-center"><i class="fa fa-download"></i></a></td>
                                        </tr>
                                    </tbody>
                                <?php endforeach; ?>
                            </table>
