                        ...
                        <form class="form-inline">
                            <div class="col-lg-6">
                                <div class="input-group ml-1 mt-2">
                                    <select name="kecamatan" id="kecamatan" class="select2 mb-2 select2-multiple card shadow form-control" name="kecamatan" data-width="100%" data-live-search="true" value="Cari Data Sesuai Dengan Kecamatan">
