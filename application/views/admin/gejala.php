    ...
    <div class="container-fluid">
                                    ...
                                    foreach ($gejala as $rs) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="" class="tabledit-delete-button btn btn-sm btn-success btn-animation mb-2" title="Update Data Gejala" data-toggle="modal" data-animation="rubberBand" data-target=".updategejala" id="modelgejala" data-id="<?= $rs['id']; ?>" data-kodegejala="<?= $rs['kodegejala']; ?>" data-namagejala="<?= $rs['nama_gejala']; ?>" data-idpenyakit="<?= $rs['id_penyakit']; ?>">
            ...
            <div class="modal fade addgejala" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="<?= base_url('admin/addgejala'); ?>" method="POST">
        ...
        <div class="modal fade updategejala" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('admin/ubahgejala'); ?>" method="POST">
                        <div class="modal-body">
                            <label for="kodegejala">Kode Gejala</label>
                            <div class="input-group">
        ...
        <script type="text/javascript">
            $(document).on("click", "#modelgejala", function() {
                ...
                $(".updategejala #namapenyakit").val(Idpenyakit);
            })
