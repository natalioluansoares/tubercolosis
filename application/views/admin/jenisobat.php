                                    ...
                                    foreach ($jenisobat as $rs) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="" class="tabledit-delete-button btn btn-sm btn-success btn-animation mb-2" title="Update Data Konsultasi" data-toggle="modal" data-animation="zoomInLeft" data-target=".updatejenisobat" id="modeljenisobat" data-id="<?= $rs['id']; ?>" data-namaobat="<?= $rs['nama_obat']; ?>" data-idpenyakit="<?= $rs['id_penyakit']; ?>">
            ...
            <div class="modal fade addjenisobat" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="<?= base_url('admin/addjenisobat'); ?>" method="POST">
                            <div class="modal-body">
                                ...
                                <div class="input-group">
                                    <select name="namapenyakit" id="namapenyakit" class="form-control">
                                        <option value="">Pilih Penyakit Anda</option>
        ...
        <div class="modal fade updatejenisobat" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('admin/ubahjenisobat'); ?>" method="POST">
                        <div class="modal-body">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(e) {
                $("#form").on("submit", (function(e) {
                    e.preventDefault();
                    $.ajax({
                        url: '<?= base_url('admin/ubahjenisobat'); ?>',
                        type: 'POST',
                        ...
                        processData: false,
                        success: function() {
                            document.location.href = "<?= base_url('admin/jenisobat'); ?>";
                        }
                    });
                }));
            })
