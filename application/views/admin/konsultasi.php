            ...
            <div class="modal fade addkonsultasi" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="<?= base_url('admin/addkonsultasi'); ?>" method="POST">
        ...
        <div class="modal fade updatekonsultasi" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('admin/ubahkonsultasi'); ?>" method="POST">
                        <div class="modal-body">
                            <label for="">Konsultasi</label>
                            <div class="input-group">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(e) {
                $("#form").on("submit", (function(e) {
                    e.preventDefault();
                    $.ajax({
                        url: '<?= base_url('admin/ubahkonsultasi'); ?>',
                        type: 'POST',
                        ...
                        processData: false,
                        success: function() {
                            document.location.href = "<?= base_url('admin/konsultasi'); ?>";
                        }
                    });
                }));
            })
