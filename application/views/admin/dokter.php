                                    ...
                                    foreach ($dokter as $dpb) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?= base_url('admin/updatedokterperawatbidan/' . $dpb['id_dopebi']); ?>" class="tabledit-delete-button btn btn-sm btn-success mb-2">
                                                ...
                                                <a href="<?= base_url('admin/adddokterperawatbidan'); ?>" class="tabledit-delete-button btn btn-sm btn-warning  mb-1" title="Input Data Dokter & Perawat & Bidan"><i class="ti-save"></i></a>
