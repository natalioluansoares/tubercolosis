                                        ...
                                        foreach ($nato as $res) : ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="" class="tabledit-delete-button btn btn-sm btn-success" title="Update Data User" data-toggle="modal" data-target=".editregister" id="modalregister" data-id="<?= $res['id']; ?>" data-lastname="<?= $res['last_name']; ?>" data-firstname="<?= $res['first_name']; ?>" data-username="<?= $res['username']; ?>" data-email="<?= $res['email']; ?>" data-jeniskelamin="<?= $res['jenis_kelamin']; ?>" data-status="<?= $res['status']; ?>" data-alamat="<?= $res['alamat']; ?>" data-idkecamatan="<?= $res['userkecamatan']; ?>" data-level="<?= $res['level']; ?>">
                ...
                <form action="<?= base_url('admin/editregister') ?>" method="POST">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <label for="level" style="color: white;">Pilih Level Anda</label>
                            <div class="input-group">
                                <select name="level" id="level" class="form-control">
                                    <option value="">Pilih Level Anda</option>
                                    <option value="dokter">dokter</option>
                        ...
                        <div class="col-lg-12">
                            <div class="input-group">
                                <select id="natalio" class="form-control">
                                    <?php foreach ($Kecamatan as $kabu) : ?>
                                        <option value="<?= $kabu['kecamatan'] ?>"><?= $kabu['kecamatan'] ?>
                                        </option>
