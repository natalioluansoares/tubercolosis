                    ...
                    <div class="card-body" style="background-color: rgb(241, 233, 233); color: black">
                        <table class="table table-striped">
                            <thead class="table-info">
                                <tr>
                                    <th data-priority="1">
                                        <form action="<?= base_url('user/anualberita'); ?>" method="post" class=" d-sm-inline-block form-inline mr-auto ml-md-0 my-2 my-md-0 mw-100 navbar-search">
                    ...
                    <div class="card m-b-30">
                        <div class="card-body" style="background-color: rgb(241, 233, 233); color: black">
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h3 class="mt-2 text-center text-primary" style="font-family:Times New Roman"><?= $title; ?></h3>
                                        <a href="<?= base_url('user/bacaberita/' . $anual['id']); ?>" class="text-muted m-b-30 font-4" style="font-family:Times New Roman" title="Click Di Sini Untuk Baca Berita">
                                            <h5 class="card-title text-center" style="font-family:Times New Roman"><?= $anual['judulberitaanual']; ?></h5>
                                        </a>
                                        <h6 class="card-title text-center text-info" style="font-family:Times New Roman"><?= $anual['namaterbit']; ?></h6>
                                        <p class="card-text text-center text-warning" style="font-family:Times New Roman"><?= $anual['kodeberitaanual']; ?></p>
                                        <h5 class="card-text text-center text-danger" style="font-family:Times New Roman"><?= $anual['alamat_berita']; ?></h5>
                                    </div>
                                </div>
