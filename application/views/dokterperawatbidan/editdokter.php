                ...
                <div class="card m-b-30">
                    <div class="card-body" style="background-color: rgb(241, 233, 233); color: black">
                        ...
                        <div class="tab-pane active p-3" id="kabupaten" role="tabpanel">
                            <form action="<?= base_url('dokterperawatbidan/prosesdokterperawatbidan'); ?>" method="POST">
                                <div class="modal-body">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" id="namadokter" placeholder="Nama Dokter" name="namadokter">
                                            <option value="<?= $dokter['id']; ?>"><?= $dokter['username']; ?></option>
                                        </select>
                                    ...
                                    <div class="input-group">
                                        <select name="kecamatan" id="kecamatan" class="form-control">
                                            <option value="<?= $dokter['namakecamatan']; ?>"><?= $dokter['namakecamatan']; ?></option>
                                    ...
                                    <div class="input-group">
                                        <select name="rumahsakit" id="rumahsakit" class="form-control">
                                            <option value="<?= $dokter['id']; ?>"><?= $dokter['nama_rumahsakit']; ?></option>
