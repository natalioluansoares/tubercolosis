                ...
                <div class="flash" data-flas1="<?php echo $this->session->flashdata('success');?>"></div>
                                    ...
                                    <p class="font-14 mb-0">
                                        <table id="datatable" class="table table-bordered table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <a href=""class="tabledit-delete-button btn btn-sm btn-success btn-animation mb-2" 
                                                title="Update Data Kecamatan" data-toggle="modal" data-animation="flipInX" 
                                                data-target=".updaterumahsakit" id="modelrumahsakit" data-id="<?= $rs['id']; ?>" 
                                                data-koderumahsakit="<?= $rs['kode_rumahsakit']; ?>"
                                                data-namarumahsakit="<?=$rs['nama_rumahsakit']; ?>" data-idkelurahan="<?=$rs['id_kelurahan']; ?>">
                                                <i class="ti-pencil"></i></a>
                                                <a href="" class="tabledit-delete-button btn btn-sm btn-danger mb-2" title="Delete Data Kecamatan"><i class="ti-trash"></i></a>
                                                <a href="" class="tabledit-delete-button btn btn-sm btn-warning btn-animation mb-2" 
                                                data-toggle="modal" data-animation="flipInY" data-target=".addrumahsakit"
                                                title="Input Data Kecamatan"><i class="ti-save"></i></a>
                                                </td>
                                            </tr>
                                            <?php endforeach;?>
                                            </tbody>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="<?= base_url('dokterperawatbidan/addrumahsakit'); ?>" method="POST">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="<?= base_url('dokterperawatbidan/ubahrumahsakit'); ?>" method="POST">
                                <div class="modal-body">
                                <label for="">Kode Rumahsakit</label>
                                    <div class="input-group">
                ...
                <script type="text/javascript">
                    ...
                    $(document).ready(function(e){
                        $("#form").on("submit", (function(e){
                            e.preventDefault();
                            $.ajax({
                                url:'<?= base_url('dokterperawatbidan/ubahrumahsakit'); ?>',
                                type:'POST',
                                ...
                                processData:false,
                                success : function(){
                                    document.location.href ="<?= base_url('dokterperawatbidan/rumahsakit'); ?>";
                                }
                            });
                        }));
                    })
