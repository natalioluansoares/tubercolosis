                        ...
                        <div class="tab-pane active p-3" id="kabupaten" role="tabpanel">
                            ...
                            <table id="datatable" class="table table-bordered table-striped">
                                <thead class="table-primary">
                                    <tr>
                                        <th>Company</th>
                                        <th data-priority="1">Kode Penyakit</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($penyakit as $rs) : ?>
                                        <tr>
                                            ...
                                            <td><?= $rs['kode_penyakit']; ?></td>
                                            <td><?= $rs['nama_penyakit']; ?></td>
                                            <td class="text-center">
                                                <a href="" class="tabledit-delete-button btn btn-sm btn-success btn-animation mb-2" title="Update Data Konsultasi" data-toggle="modal" data-animation="rubberBand" data-target=".updatepenyakit" id="modelpenyakit" data-id="<?= $rs['id']; ?>" data-namapenyakit="<?= $rs['nama_penyakit']; ?>" data-idkonsultasi="<?= $rs['kode_penyakit']; ?>">
            ...
            <div class="modal fade addkonsultasi" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="<?= base_url('dokterperawatbidan/addpenyakit'); ?>" method="POST">
                            <div class="modal-body">
                                <label for="">Kode Penyakit</label>
                                <div class="input-group">
                                    <input type="text" name="kodepenyakit" id="namakonsultasi" class="form-control">
        ...
        <div class="modal fade updatepenyakit" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('dokterperawatbidan/ubahpenyakit'); ?>" method="POST">
                        <div class="modal-body">
                            <label for="">Kode Penyakit</label>
                            <div class="input-group">
                                <input type="text" name="kodepenyakit" id="namakonsultasi" class="form-control">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(e) {
                $("#form").on("submit", (function(e) {
                    e.preventDefault();
                    $.ajax({
                        url: '<?= base_url('penyakitdokterperawatbidan/ubahpenyakit'); ?>',
                        type: 'POST',
                        ...
                        processData: false,
                        success: function() {
                            document.location.href = "<?= base_url('dokterperawatbidan/penyakit'); ?>";
                        }
                    });
                }));
            })
